...
function addProduct(name, price, bat, memoria, color, estado) {
    getExchangeRate().then(exchangeRate => {
        ...
        switch (name.toLowerCase()) {
            case 'iphone 11':
                productImage.src = 'assets/11.jpg';
            break;
            case 'iphone 11 pro':
                productImage.src = 'assets/11p.jpg';
            break;
            case 'iphone 11 pro max':
                productImage.src = 'assets/11pm.jpg';
            break;
            case 'iphone 12':
                productImage.src = 'assets/12.png';
            break;
            case 'iphone 12 pro':
                productImage.src = 'assets/12p.png';
            break;
            case 'iphone 12 pro max':
                productImage.src = 'assets/12pm.png';
            break;
            case 'iphone 13':
                productImage.src = 'assets/13.jpg';
            break;
            case 'iphone 13 pro':
                productImage.src = 'assets/13p.jpg';
            break;
            case 'iphone 13 pro max':
                productImage.src = 'assets/13pm.jpg';
            break;

            default:
                productImage.src = 'assets/applee-logo.png';
        }
...
//borra productos
    ...
    function finalizePurchase() {
        ...
        const whatsappUrl = `https://wa.me/+5492657779173?text=${encodedMessage}`;
